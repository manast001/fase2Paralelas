...
int main(int argc, char **argv) {
    ...
    for(i = inicio; i < fin; i++) {//FILA
        ...
        for(j = 0; j < ancho; j++) {//COLUMNA
                ...
                pixel.red = CLAMP(pixel.red *0.11 + pixel.green*0.59 + pixel.blue*0.3);
            pixel.green = CLAMP(pixel.red *0.11 + pixel.green*0.59 + pixel.blue*0.3);
            pixel.blue = CLAMP(pixel.red *0.11 + pixel.green*0.59 + pixel.blue*0.3);
